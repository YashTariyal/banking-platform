...
/**
 * Fail fast if risk-service is started with security enabled but
...
public class SecurityStartupValidator {
    ...
    public SecurityStartupValidator(Environment environment,
                                    @Value("${risk.security.enabled:false}") boolean securityEnabled) {
    ...
    public void validateSecurityConfiguration() {
        ...
        if ((jwkSetUri == null || jwkSetUri.isBlank())
            ...
            throw new IllegalStateException("""
                    risk.security.enabled=true but no JWT configuration found.
