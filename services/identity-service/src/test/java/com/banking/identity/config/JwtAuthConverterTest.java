...
class JwtAuthConverterTest {
    ...
    void convert_withScopeClaim_createsAuthorities() {
        Jwt jwt = Jwt.withTokenValue("token")
                .header("alg", "RS256")
                .claim("scope", "identity.read identity.write")
                .claim("sub", "user-123")
        ...
        assertTrue(authorities.stream().anyMatch(a -> a.getAuthority().equals("identity.read")));
        assertTrue(authorities.stream().anyMatch(a -> a.getAuthority().equals("identity.write")));
    }
