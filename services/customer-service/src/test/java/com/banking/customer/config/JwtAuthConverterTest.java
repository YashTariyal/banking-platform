...
class JwtAuthConverterTest {
    ...
    void convert_withScopeClaim_createsAuthorities() {
        Jwt jwt = Jwt.withTokenValue("token")
                .header("alg", "RS256")
                .claim("scope", "customers.read customers.write")
                .claim("sub", "user-123")
        ...
        assertTrue(authorities.stream().anyMatch(a -> a.getAuthority().equals("customers.read")));
        assertTrue(authorities.stream().anyMatch(a -> a.getAuthority().equals("customers.write")));
    }
