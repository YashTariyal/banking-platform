...
/**
 * Fail fast if customer-service is started with security enabled but
...
public class SecurityStartupValidator {
    ...
    public SecurityStartupValidator(Environment environment,
                                    @Value("${customer.security.enabled:false}") boolean securityEnabled) {
    ...
    public void validateSecurityConfiguration() {
        ...
        if ((jwkSetUri == null || jwkSetUri.isBlank())
            ...
            throw new IllegalStateException("""
                    customer.security.enabled=true but no JWT configuration found.
