...
/**
 * Fail fast if support-service is started with security enabled but
...
public class SecurityStartupValidator {
    ...
    public SecurityStartupValidator(Environment environment,
                                    @Value("${support.security.enabled:false}") boolean securityEnabled) {
    ...
    public void validateSecurityConfiguration() {
        ...
        if ((jwkSetUri == null || jwkSetUri.isBlank())
            ...
            throw new IllegalStateException("""
                    support.security.enabled=true but no JWT configuration found.
