...
/**
 * Fail fast if compliance-service is started with security enabled but
...
public class SecurityStartupValidator {
    ...
    public SecurityStartupValidator(Environment environment,
                                    @Value("${compliance.security.enabled:false}") boolean securityEnabled) {
    ...
    public void validateSecurityConfiguration() {
        ...
        if ((jwkSetUri == null || jwkSetUri.isBlank())
            ...
            throw new IllegalStateException("""
                    compliance.security.enabled=true but no JWT configuration found.
