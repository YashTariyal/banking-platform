...
public class RequestLoggingFilter extends OncePerRequestFilter {
    ...
    public RequestLoggingFilter(PiiMaskingFilter piiMaskingFilter, MeterRegistry meterRegistry) {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // Record metrics
            timerSample.stop(Timer.builder("http.server.requests")
                    .tag("method", method)
                    .tag("uri", path)
            ...
            if (status >= 400) {
                meterRegistry.counter("http.server.errors",
                        ...
                        "service", "compliance-service").increment();
            }
